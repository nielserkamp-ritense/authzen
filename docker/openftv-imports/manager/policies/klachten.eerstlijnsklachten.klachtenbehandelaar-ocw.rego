...
# Generated by scripts/permissions-to-rego.py from changeset `eerstelijnsklachten-klachtenbehandelaar-ocw-permission-v4`.
...
klachtbehandelaar_ocw_algemeen_case_tab_1 if {
	has_resource_type("com.ritense.case.domain.CaseTab")
	has_action(["view"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
filter contains {
	...
	"role": "ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN",
...
klachtbehandelaar_ocw_algemeen_case_definition_1 if {
...
klachtbehandelaar_ocw_algemeen_case_definition_2 if {
	has_resource_type("com.ritense.case_.domain.definition.CaseDefinition")
	has_action(["view"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_json_schema_document_1 if {
...
klachtbehandelaar_ocw_algemeen_json_schema_document_2 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["view_list"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_json_schema_document_3 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["modify"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_json_schema_document_4 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["claim"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_json_schema_document_5 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["assign"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_json_schema_document_6 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
...
klachtbehandelaar_ocw_algemeen_json_schema_document_definition_1 if {
...
klachtbehandelaar_ocw_algemeen_json_schema_document_definition_2 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocumentDefinition")
	has_action(["view_list"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_search_field_1 if {
...
klachtbehandelaar_ocw_algemeen_note_1 if {
...
klachtbehandelaar_ocw_algemeen_note_2 if {
	has_resource_type("com.ritense.note.domain.Note")
	has_action(["view_list"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_note_3 if {
	has_resource_type("com.ritense.note.domain.Note")
	has_action(["create"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_note_4 if {
	has_resource_type("com.ritense.note.domain.Note")
	has_action(["modify"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_note_5 if {
	has_resource_type("com.ritense.note.domain.Note")
	has_action(["delete"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_resource_permission_1 if {
...
klachtbehandelaar_ocw_algemeen_operaton_task_1 if {
			...
			"conditions": [
				{
					...
					"field": "groupId",
					"operator": "==",
					"value": "ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN"
				}
			]
		}
	]},
...
klachtbehandelaar_ocw_algemeen_operaton_task_2 if {
	has_resource_type("com.ritense.valtimo.operaton.domain.OperatonTask")
	has_action(["complete"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_operaton_task_3 if {
	has_resource_type("com.ritense.valtimo.operaton.domain.OperatonTask")
	has_action(["assign"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_operaton_task_4 if {
	has_resource_type("com.ritense.valtimo.operaton.domain.OperatonTask")
	has_action(["assignable"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_operaton_task_5 if {
	has_resource_type("com.ritense.valtimo.operaton.domain.OperatonTask")
	has_action(["claim"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
...
klachtbehandelaar_ocw_algemeen_operaton_task_6 if {
	has_resource_type("com.ritense.valtimo.operaton.domain.OperatonTask")
	has_action(["view"])
	has_role("ROLE_KLACHTEN_KLACHTBEHANDELAAR_OCW_ALGEMEEN")
}
