...
# Generated by scripts/permissions-to-rego.py from changeset `klachten-klachtencoordinator-ggd-permission-v7`.
...
klachtencoordinator_ggd_case_tab_1 if {
	has_resource_type("com.ritense.case.domain.CaseTab")
	has_action(["view"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
filter contains {
	...
	"role": "ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD",
...
klachtencoordinator_ggd_case_definition_1 if {
...
klachtencoordinator_ggd_case_widget_tab_widget_1 if {
...
klachtencoordinator_ggd_dashboard_1 if {
...
klachtencoordinator_ggd_json_schema_document_1 if {
...
klachtencoordinator_ggd_json_schema_document_2 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["view"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_3 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["view"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_4 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
...
klachtencoordinator_ggd_json_schema_document_5 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["view_list"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_6 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["view_list"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_7 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["create"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_8 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["create"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_9 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["create"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_10 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["modify"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_11 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["modify"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_12 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["modify"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_13 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["claim"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_14 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["claim"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_15 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["claim"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_16 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["assign"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_17 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["assign"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_18 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["assign"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_19 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
...
klachtencoordinator_ggd_json_schema_document_20 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["assignable"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_21 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["assignable"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_22 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocument")
	has_action(["assignable"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_definition_1 if {
...
klachtencoordinator_ggd_json_schema_document_definition_2 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocumentDefinition")
	has_action(["view"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_definition_3 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocumentDefinition")
	has_action(["view"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_definition_4 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocumentDefinition")
	has_action(["view_list"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_definition_5 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocumentDefinition")
	has_action(["view_list"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_json_schema_document_definition_6 if {
	has_resource_type("com.ritense.document.domain.impl.JsonSchemaDocumentDefinition")
	has_action(["view_list"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_search_field_1 if {
...
klachtencoordinator_ggd_search_field_2 if {
	has_resource_type("com.ritense.document.domain.impl.searchfield.SearchField")
	has_action(["view_list"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_search_field_3 if {
	has_resource_type("com.ritense.document.domain.impl.searchfield.SearchField")
	has_action(["view_list"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_note_1 if {
...
klachtencoordinator_ggd_note_2 if {
	has_resource_type("com.ritense.note.domain.Note")
	has_action(["view_list"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_note_3 if {
	has_resource_type("com.ritense.note.domain.Note")
	has_action(["create"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_note_4 if {
	has_resource_type("com.ritense.note.domain.Note")
	has_action(["modify"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_note_5 if {
	has_resource_type("com.ritense.note.domain.Note")
	has_action(["delete"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_resource_permission_1 if {
...
klachtencoordinator_ggd_user_1 if {
...
klachtencoordinator_ggd_operaton_execution_1 if {
...
klachtencoordinator_ggd_operaton_task_1 if {
			...
			"conditions": [
				{
					...
					"field": "groupId",
					"operator": "==",
					"value": "ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD"
				}
			]
		}
	]},
...
klachtencoordinator_ggd_operaton_task_2 if {
	has_resource_type("com.ritense.valtimo.operaton.domain.OperatonTask")
	has_action(["complete"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_operaton_task_3 if {
	has_resource_type("com.ritense.valtimo.operaton.domain.OperatonTask")
	has_action(["assign"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_operaton_task_4 if {
	has_resource_type("com.ritense.valtimo.operaton.domain.OperatonTask")
	has_action(["assignable"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_operaton_task_5 if {
	has_resource_type("com.ritense.valtimo.operaton.domain.OperatonTask")
	has_action(["claim"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
...
klachtencoordinator_ggd_operaton_task_6 if {
	has_resource_type("com.ritense.valtimo.operaton.domain.OperatonTask")
	has_action(["view"])
	has_role("ROLE_KLACHTEN_KLACHTENCOORDINATOR_GGD")
}
